...
```shell
# 安装 FFmpeg 4.x 需要的头文件，安装 FFmpeg 4.x 选第一个，安装 FFmpeg 6.x 选第二个
wget https://github.com/FFmpeg/nv-codec-headers/releases/download/n11.1.5.1/nv-codec-headers-11.1.5.1.tar.gz 
git clone https://git.videolan.org/git/ffmpeg/nv-codec-headers.git #

cd nv-codec-headers
vim Makefile 
# PREFIX=/home/linxi/DevKit/Libraries/x86_64/FFnvcodec/FFnvcodec-11.1.5.1 # 安装 FFmpeg 4.x
# PREFIX=/home/linxi/DevKit/Libraries/x86_64/FFnvcodec/FFnvcodec-latest   # 安装 FFmpeg 6.x
